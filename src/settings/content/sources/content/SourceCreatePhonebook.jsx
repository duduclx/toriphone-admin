...
const SourceCreatePhonebook = ({ source, setSource }) => {
  // requirements
  ...
  useEffect(() => {
    setSource({
      phonebook_name: null,
      phonebook_description: null,
      phonebook_uuid: null,
      first_matched_columns: ["phone", "mobile_phone", "fax"],
      format_columns: {
      ...
      name: null,
      searched_columns: ["firstname", "lastname", "email", "phone", "mobile_phone"],
    });
  }, []);
...
export default SourceCreatePhonebook;
